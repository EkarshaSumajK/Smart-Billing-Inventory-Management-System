  ...
  if (loading) return (
    <div className="card p-6 text-center text-gray-500 dark:text-gray-400">
      <div className="flex items-center justify-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-apple-blue mr-3"></div>
        {t('history.loading')}
      </div>
    </div>
  );
    ...
    <div className="space-y-12">
      ...
      <div className="page-hero">
        <div className="page-hero-content">
          <div>
            <Link to="/customers" className="text-apple-blue hover:underline text-sm mb-2 inline-flex items-center">
      ...
      <div className="page-section p-0 overflow-hidden">
        {history.length === 0 ? (
          <div className="text-center py-12">
            <svg className="w-16 h-16 text-apple-gray-400 dark:text-apple-gray-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-6h6v6m-6-4h.01M12 3v4m0 0h8m-8 0H4" />
            </svg>
            <p className="text-lg text-apple-gray-500 dark:text-apple-gray-400 font-light mb-2">
              {t('history.noHistory')}
            </p>
          ...
          <div className="overflow-x-auto">
            <table className="table w-full">
              <thead>
                <tr className="bg-apple-gray-100 dark:bg-apple-gray-900/60">
                  <th className="text-left py-4 px-6 font-semibold text-apple-gray-700 dark:text-apple-gray-300">
                    {t('history.headerBill')}
                  </th>
                  <th className="text-left py-4 px-6 font-semibold text-apple-gray-700 dark:text-apple-gray-300">
                    {t('history.headerDate')}
                  </th>
                  <th className="text-right py-4 px-6 font-semibold text-apple-gray-700 dark:text-apple-gray-300">
                    {t('history.headerTotal')}
                  </th>
                  <th className="text-center py-4 px-6 font-semibold text-apple-gray-700 dark:text-apple-gray-300">
                ...
                {history.map((bill) => {
                  ...
                  return (
                    <tr
                      ...
                      className="border-b border-apple-gray-200 dark:border-apple-gray-800/50 hover:bg-apple-gray-100/70 dark:hover:bg-apple-gray-900/40 transition-colors"
                    >
                      <td className="py-4 px-6">
                        <span className="font-mono text-apple-blue font-medium">
                          {bill.billId || "N/A"}
                        </span>
                      </td>
                      <td className="py-4 px-6">
                        <div>
                          <p className="text-apple-gray-900 dark:text-white font-medium">
                            {date}
                          </p>
      ...
      {history.length > 0 && (
        <div className="page-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-apple-blue to-[#2F81F7] rounded-2xl p-4 text-white">
              <p className="text-sm opacity-90">{t('history.totalBills')}</p>
              <p className="text-2xl font-bold">{history.length}</p>
            </div>
            <div className="bg-gradient-to-br from-[#5E5CE6] to-[#AF52DE] rounded-2xl p-4 text-white">
            ...
            <div className="bg-gradient-to-br from-[#34C759] to-[#30D158] rounded-2xl p-4 text-white">
