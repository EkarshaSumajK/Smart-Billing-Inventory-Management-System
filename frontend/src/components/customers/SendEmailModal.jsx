    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* --- Modal Header --- */}
            <div className="flex justify-between items-center p-6 border-b border-apple-gray-200 dark:border-apple-gray-800 flex-shrink-0">
              <h2 className="text-2xl font-semibold text-apple-gray-900 dark:text-white font-display">
                {t('emailModal.title')}
              </h2>
              <button
                onClick={() => onClose(false)}
                className="text-apple-gray-500 hover:text-apple-gray-900 dark:hover:text-white transition-colors"
                disabled={loading}
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto custom-scrollbar space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-apple-gray-600 dark:text-apple-gray-400 mb-1.5">
                  {t('emailModal.recipients')}
                </label>
                <div className="form-input bg-apple-gray-100 dark:bg-apple-gray-900/50 p-3 rounded-2xl text-apple-gray-700 dark:text-apple-gray-300">
                  {getRecipientText()}
                </div>
              </div>

              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-apple-gray-600 dark:text-apple-gray-400 mb-1.5">
              ...
              <div>
                <label htmlFor="body" className="block text-sm font-medium text-apple-gray-600 dark:text-apple-gray-400 mb-1.5">
            ...
            {/* --- Modal Footer --- */}
          <div className="flex justify-end items-center p-6 border-t border-apple-gray-200 dark:border-apple-gray-800 flex-shrink-0 bg-apple-gray-50 dark:bg-apple-gray-900/50 rounded-b-3xl space-x-3">
              <button
                type="button"
                onClick={() => onClose(false)}
