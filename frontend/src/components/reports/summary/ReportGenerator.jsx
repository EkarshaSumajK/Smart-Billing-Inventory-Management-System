...
const CustomDateInput = React.forwardRef(({ value, onClick, placeholder }, ref) => (
  <button
    ...
    ref={ref}
    onClick={onClick}
    className="form-input w-full !pl-10 !py-2.5 rounded-md cursor-pointer text-left"
  >
      ...
      <div className="space-y-12">
        ...
        >
          <div className="page-hero-content">
            <div>
              <p className="page-hero-eyebrow">Reports</p>
              <h1 className="page-hero-title">{t('reports.title')}</h1>
              <p className="page-hero-subtitle">{t('reports.subtitle')}</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center">
            ...
            <div className="flex-1 w-full">
              <label className="block text-sm font-semibold text-apple-gray-600 dark:text-apple-gray-300 mb-2">{t('reports.dateRange')}</label>
              ...
              <AnimatePresence mode="wait">
                {!reportData ? (
                  <motion.button
                    ...
                    disabled={loading}
                    className="button-primary w-full sm:w-48 h-10 flex items-center justify-center gap-3 shadow-apple-sm"
                  >
                  ...
                  >
                    <button
                      ...
                      className="button-primary h-10 px-5 flex items-center justify-center gap-3 bg-[#40C057] hover:bg-[#37B24D] shadow-apple-sm"
                    >
                    ...
                    <button
                      ...
                      disabled={isDownloading}
                      className="button-secondary h-10 px-5 flex items-center justify-center gap-3"
                    >
                      <ClearIcon />
                      {t('reports.newReport')}
                    </button>
          ...
          {loading && (
            ...
            >
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-apple-gray-900 dark:text-white mb-2">{t('reports.loading')}</h3>
                  <p className="text-apple-gray-600 dark:text-apple-gray-400">{t('reports.loadingSub')}</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {!loading && !reportData && !error && (
            ...
            >
              <div className="max-w-md mx-auto">
                <div className="w-24 h-24 mx-auto mb-6 bg-apple-gray-200 dark:bg-apple-gray-900/60 rounded-2xl flex items-center justify-center">
                  {/* UPDATED: Icon color */}
                  <ReportIcon className="w-10 h-10 text-apple-gray-500 dark:text-apple-gray-300" />
                </div>
                <h3 className="text-2xl font-bold text-apple-gray-900 dark:text-white mb-3">{t('reports.placeholderTitle')}</h3>
                <p className="text-apple-gray-600 dark:text-apple-gray-400 text-lg mb-8">
                  {t('reports.placeholderSub')}
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-apple-gray-500 dark:text-apple-gray-500">
                  <div className="text-center">
                    <div className="w-8 h-8 bg-apple-gray-200 dark:bg-apple-gray-900/60 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <span className="text-apple-blue font-medium">Chart</span>
                    </div>
                    <p>{t('reports.placeholder1')}</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 bg-apple-gray-200 dark:bg-apple-gray-900/60 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <span className="text-[#5E5CE6] font-medium">AI</span>
                    </div>
                    <p>{t('reports.placeholder2')}</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 bg-apple-gray-200 dark:bg-apple-gray-900/60 rounded-lg flex items-center justify-center mx-auto mb-2">
                      <span className="text-[#34C759] font-medium">PDF</span>
                    </div>
